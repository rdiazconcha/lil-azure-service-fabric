    ...
    internal static class Program
    {
        ...
        private static void Main()
        {
            try
            {
                ...
                ServiceRuntime.RegisterServiceAsync("ProductsType",
                    context => new Products(context)).GetAwaiter().GetResult();

                ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(Products).Name);
